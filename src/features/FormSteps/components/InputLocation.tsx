...
export function InputLocation({setValue}:Props){
  ...
  {data && !isLoading &&
  <span className="flex items-center rounded-md bg-green-500/10 px-2 py-1 w-fit gap-1 mt-2 text-green-600">
  ...
  {error && !isLoading && <span className='flex items-center rounded-md bg-red-500/10 px-2 py-1 w-fit gap-1 mt-2 text-red-500'>
